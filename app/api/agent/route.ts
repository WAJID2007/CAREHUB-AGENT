...
interface AgentResponse {
  ...
  status: {
    aiRouter: ReturnType<ReturnType<typeof getAIRouter>['getStatus']>;
    memory: Awaited<ReturnType<ReturnType<typeof getMemoryAgent>['getStats']>>;
  };
}
...
async function handleDirectAction(action: string, params: Record<string, unknown>): Promise<{
  success: boolean;
  response: string;
  agent: string;
}> {
...
function registerAgentHandlers(orchestrator: ReturnType<typeof getOrchestrator>): void {
  // Theme Designer
