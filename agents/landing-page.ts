...
export class LandingPageBuilder {
  ...
  private async generateContent(request: LandingPageRequest, mood: string): Promise {
...
.carehub-lp-body nav {
  ...
  async buildForFacebook(request: LandingPageRequest): Promise {
  ...
  async buildForGoogle(request: LandingPageRequest): Promise {
    return this.buildLandingPage({
      ...request,
      adPlatform: 'google',
  ...
  async buildForTikTok(request: LandingPageRequest): Promise {
    return this.buildLandingPage({
      ...request,
      adPlatform: 'tiktok',
  ...
  async deleteLandingPage(handle: string): Promise {
    try {
